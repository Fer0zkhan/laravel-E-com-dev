            ...
            <div class="row d-flex justify-content-center">
                <div class="col-6">
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            <form accept="{{ route('admin_edit_product', ['id' => $products->id]) }}" method="post"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" value="{{ $products->product_sale_price }}" name="product_sale_price" class="form-control"
                                    ...
                                    required>{{ $products->product_discription}}</textarea>
